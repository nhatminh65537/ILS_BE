...
namespace ILS_BE.API.Controllers
{
    ...
    {
        private readonly IDataService<LifecycleStateDTO> _dataService;
        public LifecycleStatesController(IDataService<LifecycleStateDTO> dataService)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Put(int id, LifecycleStateDTO lifecycleState)
        {
