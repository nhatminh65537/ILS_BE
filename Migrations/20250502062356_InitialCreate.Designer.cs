...
namespace ILS_BE.Migrations
{
    ...
    [Migration("20250502062356_InitialCreate")]
            ...
            modelBuilder.Entity("ILS_BE.Domain.Models.LearnLesson", b =>
                {
                    ...
                    b.HasIndex("Title")
                        .IsUnique()
                        .HasDatabaseName("ix_learn_lessons_title");
            ...
            modelBuilder.Entity("ILS_BE.Domain.Models.LearnTag", b =>
                {
                    ...
                    b.HasIndex("LearnModuleId")
                        .HasDatabaseName("ix_learn_tags_learn_module_id");
            ...
            modelBuilder.Entity("ILS_BE.Domain.Models.LearnTag", b =>
                {
                    b.HasOne("ILS_BE.Domain.Models.LearnModule", null)
                        ...
                        .HasConstraintName("fk_learn_tags_learn_modules_learn_module_id");
                });
